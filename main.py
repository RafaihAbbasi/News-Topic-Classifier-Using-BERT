{
  ...
  "metadata": {
    "colab": {
      ...
      "authorship_tag": "ABX9TyMrmJ0s/y1t8UEj7Q+Qi1W8",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/RafaihAbbasi/News-Topic-Classifier-Using-BERT/blob/main/main.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
